  ...
  (
    ...
    return (
      <motion.div
        ref={ref}
        className={cn(
          "relative flex flex-col overflow-hidden rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white",
          !noBorder && "border border-gray-200 dark:border-gray-800",
          !noBorder && "shadow-sm transition-shadow duration-300 ease-in-out",
          isHovered && !disableGrow && "shadow-lg",
          className
        )}
        initial={false}
        animate={{
